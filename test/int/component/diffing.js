...
module.exports = function(View) {
  ...
  describe('Test Diff:', () => {
    ...
    // const elX = document.getElementById('appD1');
    // Diff.diff(Diff.stringToHTML(template), elX);
    // _dump(elX);

    it('Expects "const [,,, Diff] = View._setTestMode();" to return an object.', () => {
    ...
    it('Expects "diff(template, dom)" to add the child "<h1>My Todos</h1>".', () => {
      const el = document.getElementById('appD1');
